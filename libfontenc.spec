...
Source0  : https://www.x.org/releases/individual/lib/libfontenc-1.1.7.tar.gz
Source1  : https://www.x.org/releases/individual/lib/libfontenc-1.1.7.tar.gz.sig
...
%prep
%setup -q -n libfontenc-1.1.7
cd %{_builddir}/libfontenc-1.1.7
pushd ..
cp -a libfontenc-1.1.7 build32
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1670530127
